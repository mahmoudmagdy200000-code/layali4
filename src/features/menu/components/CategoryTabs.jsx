...
export function CategoryTabs({ categories, activeId, onSelect }) {
  return (
    <div className="w-full flex overflow-x-auto justify-start gap-3 px-4 sm:px-6 py-2 flex-nowrap snap-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      {categories.map((cat) => {
        ...
        return (
          <button
            ...
            className={`
              ...
              whitespace-nowrap flex-shrink-0 snap-center active:scale-95
              ${isActive 
